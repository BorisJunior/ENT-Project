...
<body class="animsition">
  <div class="wrapper ">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Elaboration de l'emploi du temps</h4>
                   <div class="dropdown">
   ...
   <form method="POST" action="emp.php">
                                                ...
                                                <td class="text-right"> <button type="submit" formtarget="_blank" class="btn btn-primary">Emploi du temps de cette salle</button> </td>
