...
if ($_SESSION['login']) {
  ...
  $query="SELECT id_prof, nom_prof, prenom_prof FROM professeur  WHERE id_prof IN (SELECT id_prof FROM dispensercours WHERE id_classe is NULL)";
...
<body class="animsition">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton"  style="margin-left: 455px">
    ...
    <a class="dropdown-item" href="supprof.php">Supprimer compte professeur</a>
              ...
              <div class="card-header">
                <h4 class="card-title">Mise en place des professeurs sur la plateforme</h4>
              </div>
              <div class="card-body">
