...
if ($_SESSION['login']) {
 ...
 $query="SELECT DISTINCT professeur.id_prof, nom_prof, prenom_prof, id_classe FROM professeur INNER JOIN dispensercours ON  professeur.id_prof = dispensercours.id_prof WHERE professeur.id_prof IN (SELECT id_prof FROM dispensercours WHERE id_classe is NOT NULL ) ORDER BY nom_prof ASC ";
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton"  style="margin-left: 455px">
   ...
   <form method="POST" action="inter.php">
                                                ...
                                                <td><input type="text" name="" value="'.$row[1].'" disabled>
                                                    <input type="hidden" name="profnom" value="'.$row[1].'"> </td>

                                                <td><input type="text" name="" value="'.$row[2].'" disabled>
                                                    <input type="hidden" name="profprenom" value="'.$row[2].'"> </td>
                                                

                                                <td class="text-right"> <button type="submit" formtarget="_blank" class="btn btn-primary">Voir Matieres</button> </td>
