...
if ($_SESSION['login']) {
  ...
  $query="SELECT  DISTINCT semestre FROM ec WHERE statut = 'Actif' ORDER BY semestre ASC";
   $result = pg_query($db_handle, $query) or die("Cannot execute query: $query\n");
  


  $query2="SELECT  DISTINCT semestre FROM ec WHERE statut = 'Bloque' ORDER BY semestre ASC";
...
<body class="animsition">
 ...
 <form method="POST" action="../xBackEnd/activer.php">
...
<form method="POST" action="../xBackEnd/bloquer.php">
