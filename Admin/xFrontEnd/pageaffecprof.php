...
session_start();
 ...
 $query="SELECT libelle_ec FROM ec  WHERE id_classe= '$classe'";
...
<body class="animsition">
  <div class="wrapper ">
          ...
          <div class="col-md-12">
            <div class="card card-plain">
              <div class="card-header">
                <h4 class="card-title">Choisir une matière</h4>
              </div>
              <div class="card-body">
   ...
   <form method="POST" action="../xBackEnd/traitementaffecprof.php">
