...
if ($_SESSION['login']) {
 ...
 $query="SELECT id_classe, niveau FROM classe ORDER BY niveau ASC ";
...
<body class="animsition">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton"  style="margin-left: 455px">
    ...
    <a class="dropdown-item" href="misetud.php">Mise en place d'étudiants sur la plateforme</a>
   ...
   echo' 
   <form method="POST" action="interetud.php">

                                                <tr>
                                                <td><input type="text" name="" value="'.$row[0].'" disabled >
                                                    <input type="hidden" name="classe" value="'.$row[0].'"></td>

                                                <td>'.$row[1].'</td>

                                                <td class="text-right"> <button type="submit" formtarget="_blank" class="btn btn-primary">Voir les étudiants de cette salle</button> </td>
