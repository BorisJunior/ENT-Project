...
$query="SELECT matricule, nom_etud, prenom_etud, id_classe FROM etudiant WHERE id_classe IS NOT NULL ORDER BY id_classe, nom_etud";
...
<body class="animsition">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Affectation des élèves dans leur salle</h4>
                   <div class="dropdown">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton"  style="margin-left: 455px">
    ...
    <a class="dropdown-item" href="misetud.php">Mise en place d'étudiants sur la plateforme sur la plateforme</a>
    <a class="dropdown-item" href="supetud.php">Supprimer compte etudiant</a>
   ...
   echo' 
    <form method="POST" action="../xBackEnd/pagesuppressetud.php">
                                                ...
                                                <td class="text-right"> <button type="submit" class="btn btn-primary">Supprimer Compte Etudiant</button> </td>
