...
$query1="SELECT ec.id_ec, ec.libelle_ec, dispensercours.id_classe FROM ec INNER JOIN dispensercours ON ec.id_ec = dispensercours.id_ec WHERE dispensercours.id_prof=(SELECT id_prof FROM professeur WHERE id_prof = '$id') ";
  ...
  <section id="intro" class="clearfix">
    <div class="container">
      ...
      <div class="intro-info">
        <h2>Pocéder à l'upload du<br><span> document</span> pour les étudiants étudiants<br> 
      </h2></div>
        ...
        <header class="section-header">
          ...
          <p>IAI-Online vous offre la possibilité de procéder à la notation des étudiants ayant composés dans la/les matière(s) vous enseignez en ligne</p>
            ...
            <div id="about" class="container-fluid">
                <h3 class="text-dark mb-4">Charger votre document ici </h3>
                <div class="card shadow">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 font-weight-bold">UPLOAD</p>
                    </div>
                    <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <?php
                     while ($row2 = pg_fetch_row($result11)) {
