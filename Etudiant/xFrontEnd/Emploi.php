...
if ($_SESSION['login']) {
 ...
 $query = "SELECT horaire_un, horaire_deux, horaire_trois, horaire_quatre, dateemp
 FROM emploidutemps
          ...
          <div class="col-lg-10 wow fadeInUp pt-5 pt-lg-0">
            <div class="card shadow">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 font-weight-bold">Consultez votre planning</p>
                    </div>
                    <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <input type="text" disabled="" class="form-control"<?php echo'value="Emploi du temps du '.$row1[4].'"';?>>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" disabled="" class="form-control" <?php echo'value="'.$row1[2].'"';?>>
