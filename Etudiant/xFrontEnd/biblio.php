...
if ($_SESSION['login']) {
 ...
 $query = "SELECT nom, categorie, date_ajout, link
 FROM biblio
 ORDER BY categorie";
          ...
          <div class="col-lg-10 wow fadeInUp pt-5 pt-lg-0">
            <div class="card shadow">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 font-weight-bold">Retrouvez de nombreux ouvrages pour vous perfectionner</p>
                    </div>
                    <div class="card-body">
                 ...
                 <div class="row">
                    <div class="col-md-12">
                      <div class="form-group" style="text-align: center;">
                        <a <?php echo'href="'.$row1[3].'"';?>><button class="btn btn-primary">Télécharger</button></a>
                      </div>
                    </div>
                  </div>
                  <?php
