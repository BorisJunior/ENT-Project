...
@media only screen and (max-width: 600px){
    ...
    .central-body{http://salehriaz.com/404Page/img/logo.svg
        padding-top: 25%;
    }
}
        ...
        <div class="stars">
            <div class="custom-navbar">
                <div class="brand-logo">
                    <img src="../images/logi.png" width="80px">
                </div>
                
            </div>
            <div class="central-body">
                <img class="image-404" src="http://salehriaz.com/404Page/img/404.svg" width="300px">
                <a href="../Login/loginetud.php" class="btn-go-home" target="_blank">GO BACK HOME</a>
            </div>
            <div class="objects">
