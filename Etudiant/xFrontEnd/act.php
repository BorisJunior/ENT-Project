          ...
          <div class="col-lg-10 wow fadeInUp pt-5 pt-lg-0">
            <div class="card shadow">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 font-weight-bold">Retrouvez ici tous vos <?php echo''.$var;?> </p>
                    </div>
                    <div class="card-body">
